    ...
    public Docket swaggerSpringPlugin() {
        return (new Docket(DocumentationType.OAS_30))
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select().apis(RequestHandlerSelectors.basePackage("${package}.web.controller")).build()
                .tags(new Tag("product", environment.getProperty("swagger.product.api.description")))//TODO change Name
